...
class INSIDEUS_API UM_InputManager : public UObject
{
	GENERATED_BODY()
	...
	DECLARE_DYNAMIC_MULTICAST_DELEGATE_ThreeParams(FOnInputActionRebind, const FInputActionData&, _input, FInputActionKeyMapping, oldMapping, FInputActionKeyMapping, _newMapping);
	DECLARE_DYNAMIC_MULTICAST_DELEGATE_ThreeParams(FOnInputAxisRebind, const FInputAxisData&, _input, FInputAxisKeyMapping, oldMapping, FInputAxisKeyMapping, _newMapping);
...
public:
	...
	FORCEINLINE const UDT_InputInfoDataTable* GetInputInfoDataTable() const { return InputInfoDataTable; }
